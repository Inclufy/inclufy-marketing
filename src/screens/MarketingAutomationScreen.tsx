...
export default function MarketingAutomationScreen() {
  ...
  const styles = useThemedStyles((c) => ({
    ...
    autoInfo: { flex: 1 },
    autoTrigger: { fontSize: fontSize.xs, fontWeight: fontWeight.bold, color: c.primary, marginBottom: 3 },
    autoAction: { fontSize: fontSize.sm, color: c.text, lineHeight: 18 },
    autoMeta: { marginTop: spacing.xs, paddingTop: spacing.xs, borderTopWidth: 1, borderTopColor: c.borderLight },
    ...
    logDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: c.primary, marginTop: 5, flexShrink: 0 },
    logInfo: { flex: 1 },
