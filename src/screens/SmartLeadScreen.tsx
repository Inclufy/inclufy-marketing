...
export default function SmartLeadScreen() {
  ...
  const styles = useThemedStyles((c) => ({
    ...
    myCardLeft: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: spacing.sm },
    myCardIconWrap: {
      width: 40,
      height: 40,
      borderRadius: 20,
    ...
    cardTitle: { fontSize: fontSize.sm, fontWeight: fontWeight.semibold, color: c.text, marginBottom: 4 },
    cardSub: { fontSize: fontSize.xs, color: c.textSecondary, lineHeight: 16 },
    contactRow: {
      flexDirection: 'row' as const,
      alignItems: 'center' as const,
      backgroundColor: c.surface,
    ...
    avatarText: { color: c.primary, fontWeight: fontWeight.bold, fontSize: fontSize.sm },
    contactInfo: { flex: 1 },
    contactName: { fontSize: fontSize.sm, fontWeight: fontWeight.semibold, color: c.text },
    contactSub: { fontSize: fontSize.xs, color: c.textSecondary, marginTop: 2 },
    sourceBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12 },
    sourceText: { fontSize: 10, fontWeight: fontWeight.semibold, textTransform: 'capitalize' as const },
  }));
