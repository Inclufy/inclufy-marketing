  ...
  const opportunities = [
    {
      ...
      campaign_suggestion: `Launch "${template.industry} Digital Transformation" thought leadership campaign`,
    },
    {
      ...
      campaign_suggestion: `Launch "Switch from ${template.competitors[0]?.name}" migration program`,
    },
    {
      ...
      campaign_suggestion: `Develop co-branded webinar series with the association`,
    },
    {
      ...
      campaign_suggestion: `Launch "${template.industry} Compliance Readiness" assessment campaign`,
    },
  ];
