...
const AMOS_MODULES: AMOSModule[] = [
  ...
  },
  {
    ...
    nameNl: 'Autonoom Hub',
    nameFr: 'Hub Autonome',
    description: 'AI autonomous marketing operations',
    descriptionNl: 'Autonome AI marketing operaties',
    descriptionFr: 'Opérations marketing autonomes IA',
    icon: 'brain',
    iconLib: 'mci',
    color: '#7C3AED',
    status: 'active',
  ...
  },
  {
    ...
    nameFr: 'Moteur de Réseautage',
    description: 'Capture & enrich contacts via QR/NFC',
    descriptionNl: 'Leg contacten vast via QR/NFC',
    descriptionFr: 'Capturez des contacts via QR/NFC',
